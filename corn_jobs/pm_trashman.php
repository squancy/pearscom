<?php
	...
	$query = mysqli_query($conn, "SELECT id FROM pm WHERE parent='x' AND rdelete='1' AND hasreplies='0'");
	...
	$query3 = mysqli_query($conn, "SELECT id FROM pm WHERE parent='x' AND sdelete='1' AND rdelete='1'");
