...
otherSprites.src = "images/spirites_big.png";
...
function calcMills(ms){
    ...
    console.log(x[1] + "." + mills);
    return x[1] + "." + mills;
}

function drawRetry(btnHolder, GAME_LEVELS, CanvasDisplay, level){
    ...
    retryBtn.addEventListener("click", () => {
        ...
        runGame(GAME_LEVELS, CanvasDisplay, level);
        setT();
        clearDate();
    });
}
...
async function runGame(plans, Display, lvl){
    let playerLives = 2;
