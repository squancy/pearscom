<?php
  ...
  header("Content-Security-Policy: default-src https: 'unsafe-eval' * blob: 'unsafe-inline'; object-src 'none'; frame-ancestors https://www.pearscom.com; font-src 'self' data:; img-src https://www.pearscom.com https://maps.googleapis.com data:");
