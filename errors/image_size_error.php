...
<body style="background: linear-gradient(#ffffe6, #fff);">
	<div id="pageMiddle_2" style="margin-top: -10px; min-height: 700px; background: transparent;">
      ...
      The image you want to upload is too small therefore it has no demensions.
    </p>
		<div style="width: 50%; height: auto; float: left; background-color: #763626;
      border-left: 5px solid red;" id="divf1">
			<img src="images/404pear.png" width="100%" height="auto" style="display: block;
        margin: 0 auto; max-width: 500px;">
		</div>
		<div style="float: right; width: 48%;" id="divf2">
			<p style="font-size: 14px; margin: 0px;">
        Sorry, but the image you want to upload has no demesions.
      </p>
			<p style="font-size: 14px; margin: 0px;">
